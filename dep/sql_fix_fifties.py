...
if __name__ == '__main__':
    try:
        ...
        set_scrape('http://www.vintagecardprices.com/set-profile/2665/1952-Topps-Look-N-See-Baseball-Card-Value-Prices.htm', "Topps Look N' See", 1952, 'http://www.vintagecardprices.com/baseball-card-price-guide.htm?action=search&cat=topps&set_name=topps')
