...
# """SELECT * FROM vintagecp WHERE set_name = 'Topps' AND category=1
# AND year = 1958 AND id between 2656 AND 2677"""

# # for n in range(1, 11):
# r = requests.post('http://ws.vintagecardprices.com', data={"queryXml": xml_req(set_name='Topps', sport_type=1, player_name='', card_number='24y', year=1958, grader="psa", grade=7)}, auth=('wta', 'R2rGPrHL8'))
